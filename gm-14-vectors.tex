...
Consider a frustum. 
  \begin{figure}[h]
    \includegraphics[scale=2.5]{./frustum.png}
  \end{figure}
\end{frame}
...
\end{equation}
As we know the formula of the volume for a cylinder (base times
...
\begin{frame}
  ...
  \end{equation}
Use (\ref{eq:iegaiqua}) and (\ref{eoqueeci}) for the following
equation,
\begin{equation}
  \label{eq:ohchoomu}
