...
\begin{frame}
  ...
  \end{equation}
We can easily calculate the LHS (left-hand side), and the RHS provides
us with the coordinates of point $Q$.
  \begin{figure}[h]
    \includegraphics[scale=.5]{./vectora.png}
  \end{figure}
\end{frame}
...
{\ubung}  An office safe was lowered from an office building by two cables
  ...
  1250 pounds.
  \begin{figure}[h]
    \includegraphics[scale=.45]{./vector-resultant-01.png}
  \end{figure}
\end{frame}
