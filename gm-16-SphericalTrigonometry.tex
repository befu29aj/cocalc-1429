...
\begin{frame}
  ...
  \begin{figure}[h]
    \includegraphics[scale=.2]{./SphericalTriangle.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{equation}
    \label{eq:likashai}
    \frac{\pi}{4}\sim\frac{\pi}{4}\cdot{}6378.1km=5009.3km
  \end{equation}
...
\begin{frame}
  ...
  The three sides $a,b,c$ of a spherical triangle are arcs on a great
  circle. These three great circles have two poles each.
\end{frame}
