...
% . Find the length of the great-ci@e track from the Brooklyn Navy 

% Yard (400 42' N, 730 59' W), td' the point where the prime meridian 

% crosses the equator. 

% ,. Find the length and the initial bearing of the great-circle track from 

% Pearl Harbor (210 27' N, 1570 57' W) to San Francisco (37 32' N, 

% 1220 13' W). 

% . A ship sails from Boston (420 20' N, 700 53' W) to Lisbon (380 40' N, 

% 90 18' W). Find the distance of the great-circle track. Also find the 

% bearing of the track when leaving Boston and when approaching 

% Lisbon. 

% . Find the length of the shortest air route between Cape Town (330 56' 

% S, 180 28' E) and Dakar (140 40' N, 170 25' W). What is the bear- 

% ing of this track as the plane leaves Cape Town. 

% , Find the shortest distance between Greenwich (51 c 29' N) and New 

% York City (400 46' N, 730 51' W). Also find the initial direction of 

% the track. 

% . What is the shortest distance from Moscow (550 43' N, -3T 34' E) 

% to London (510 31' N, oc 6' W)? Find the initial bearing of the 
...
% An airplane flies the great-circle track from Tokyo (350 39' N, 

% 1390 45' E) to Wellington (410 17' S, 1740 47' E). 

% a. Find the length and initial direction of the great-circle track. 

% b. How far from Tokyo does the plane cross the equator and what 

% is the longitude at the point of crossing? 

% c. What is the bearing of the great-circle track as the plane crosses 

% the equator? 

% A plane leaves Chicago (410 50' N, 8T 36' W) on a great-circle track 

% with an initial bearing of 630 30'. What is the latitude and longitude 

% of the plane after traveling 1000 miles (nautical)? 

% If you were to make a nonstop flight from the city of Dayton, Ohio 

% (390 46' N, 840 12' W) to Tokyo (350 39' N, 1390 45' E) by the 

% shortest route, in which direction would you start your flight? 

% A plane leaves Los Angeles (340 03' N, 1180 14' W) on a great- 

% circle track with an initial bearing of 650. Find the latitude and lon- 

% gitude of the plane when it has flown 1000 nautical miles. 